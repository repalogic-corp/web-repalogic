...
//Authentication
Route::get('/page_auth_forget', [PageController::class, 'page_forget'])->name('page_forget');
Route::get('/page_auth_locked', [PageController::class, 'page_locked'])->name('page_locked');
Route::get('/page_auth_login', [PageController::class, 'page_login'])->name('page_login');
Route::get('/page_auth_login_alt', [PageController::class, 'page_login_alt'])->name('page_login_alt');
Route::get('/page_auth_register', [PageController::class, 'page_register'])->name('page_register');
Route::get('/page_auth_confirmation', [PageController::class, 'page_confirmation'])->name('page_confirmation');

//Error Pages
Route::get('/page_error_general', [PageController::class, 'page_error'])->name('page_error');
...
//blank
Route::get('/page_blank', [PageController::class, 'blank'])->name('blank');
