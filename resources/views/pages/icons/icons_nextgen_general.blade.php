    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_4'])
                ...
                @endslot
                @slot('sh_titile_sub')
                    <span class='fw-300'>General</span>
                @endslot
                @slot('sh_descipt')
...
@section('plugin')
    <script>
        ...
        var filename =
        "/media/data/ng-icon-list"; //available JSON files [ng-icon-base, ng-icon-list, ng-text-colors, fa-brand-list, fa-icon-list]
