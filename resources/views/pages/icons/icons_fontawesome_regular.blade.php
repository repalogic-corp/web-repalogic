    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_4'])
                ...
                @endslot
                @slot('sh_titile_sub')
                    <span class='fw-300'>Regular</span>
                @endslot
                @slot('sh_descipt')
...
@section('plugin')
    <script>
        ...
        var filename =
            "/media/data/fa-icon-list"; //available JSON files [ng-icon-base, ng-icon-list, ng-text-colors, fa-brand-list, fa-icon-list]
