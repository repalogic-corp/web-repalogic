    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_4'])
                ...
                @endslot
                @slot('sh_titile_sub')
                    <span class='fw-300'>Generate Stack</span> <sup class='badge badge-success fw-500'>ADDON</sup>
                @endslot
                @slot('sh_descipt')
                        ...
                        <div class="row">
                            <div class="col-12 col-xl-auto">
                                <div class="d-flex align-items-center justify-content-center position-relative w-100 mb-g mb-xl-0"
                                    style="font-size: 250px; min-width: 301px; height: 351px; background: url(img/backgrounds/bg-5.png) #fff; border-left:0; border-top:0; ">
                                    <h6
