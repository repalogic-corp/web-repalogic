    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_5'])
                ...
                @endslot
                @slot('sh_titile_main')
                    Date Range Picker<sup class='badge badge-primary fw-500'>ADDON</sup>
                @endslot
                @slot('sh_descipt')
            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>This date range picker component creates a dropdown menu from which a user can select a range of
                            dates. I created it while building the UI for Improvely, which needed a way to select date
                            ranges for reports. Features include limiting the selectable date range, localizable strings and
                            date formats, a single date picker mode, a time picker, and predefined date ranges.</p>
                        <p class="m-0">
                            Find in-depth, guidelines, tutorials and more on Addon's <a
                                href="http://www.daterangepicker.com/" target="_blank">Official Documentation</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-lg-3 form-label text-lg-right">Date Range Picker
                                    With Times</label>
                                <div class="col-12 col-lg-6">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-lg-3 form-label text-lg-right">Single Date
                                    Picker</label>
                                <div class="col-12 col-lg-6">
                                    <div class="input-group">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="datepicker-modal-3">Date Range Picker With
                                                    Times</label>
                                                <div class="input-group">
