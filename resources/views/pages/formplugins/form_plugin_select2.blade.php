    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_5'])
                ...
                @endslot
                @slot('sh_titile_main')
                    Select2 <sup class='badge badge-primary fw-500'>ADDON</sup>
                @endslot
                @slot('sh_descipt')
                    Select2 is a jQuery-based replacement for select boxes. It supports searching, remote data sets, and pagination
                    of results.
                @endslot
            @endcomponent
        </div>
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-block">Select2 will respond to the <code>disabled</code> attribute on
                                    ...
                                    <code>disabled: true</code> to get the same effect.</div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-block">You can configure how Select2 searches for remote data using the
                                    ...
                                    <code>$.ajax</code> function, or the transport function you specify.</div>
                            </div>
                        </div>
                    </div>
                </div>
