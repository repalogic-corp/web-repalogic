    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="card mb-g">
            <div class="card-body">
                ...
                <p>
                    Node.js® is a JavaScript runtime built on Chrome's V8 JavaScript engine. Node.js is required in order to
                    run the application build tools. Download the latest version of Node and install it:
                ...
                <p>
                    Npm is the package manager for JavaScript and the world’s largest software registry. Npm is a separate
                    project from Node.js, and tends to update more frequently. As a result, even if you’ve just downloaded
                ...
                <p>
                    Gulp is a toolkit that helps you automate your time-consuming tasks in development workflow. To install
                    gulp globally.
                </p>
                <code class="bg-fusion-500 d-block w-100 pt-2 pr-3 pb-2 pl-3 fw-700 mb-3">
                ...
                <p>
                    If you have previously installed a version of <code>gulp</code> globally, please remove it to make sure
                    old version doesn't collide with new <code>gulp-cli</code>
                </p>
                <code class="bg-fusion-500 d-block w-100 pt-2 pr-3 pb-2 pl-3 fw-700 mb-3">
                    npm rm --global gulp
                </code>
                ...
                <p>
                    NPM packages are a great way to ensure your files are up to date and everyone in your development tree
                    is using the same version for the files. To install the npm you simple type:
                </p>
                <code class="bg-fusion-500 d-block w-100 pt-2 pr-3 pb-2 pl-3 fw-700 mb-1">
                    npm install
                </code>
                <div class="mb-3 help-block">
                    You may or may not see sime messages regarding vulnerabilities, we and the npm community, are aware of
                    these issues and you can choose to ignore them or upgrade your jquery to the latest version (warning:
                    doing so may break IE10 Datatables responsive plugin)
                </div>
                <p>
                ...
                <p>
                    If you are updating the npm packages, please be sure to read their changelogs for any breaking changes
                    before you do any major update. To update a package, simple open your package.json file and change the
                    version number run <code>npm i</code> command
                </p>
                <div class="height-1 mb-3"></div>
                <h3>
                    5. Build project
                ...
                <p>
                    Once all your NPM packages are installed you can now run the command to build your project. The build
                    project will compile your project and create the necessary HTML files, CSS, and JS scripts related for
                    each page. Once the compilation is completed, gulp will switch to 'watch' mode and watch for changes in
                    your JS/HBS templates/SCSS files. Any changes you make, gulp will auto compile the project in seconds.
                </p>
                <code class="bg-fusion-500 d-block w-100 pt-2 pr-3 pb-2 pl-3 fw-700 mb-1">
                    gulp build
                </code>
                <p>Once the compilation is complete, you can go to <a href="http://localhost:4000"
                        target="_blank">http://localhost:4000</a> to view your compiled project</p>
                <div class="height-1 mb-3"></div>
                <h3>
                    Other commands
                    <small>
            ...
            <div class="card-body">
                <h2 class="fw-700 mb-g">
                    ...
                    <small>
                        ...
                        the navigation speed, disable visual effects, and change localstorage settings.
                    </small>
                </h2>
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
        ...
        <div class="card mb-g">
            <div class="card-body">
                ...
                <p>All support questions related to HTML and/or CSS will be honored. Issues that are encountered on the Seed
                    versions of specific flavors of SmartAdmin are covered by their <a
                        href="https://www.gotbootstrap.com/intel_introduction.html" target="_blank">respective authors</a>,
                    but will be limited to HTML and/or CSS issues. If you need assistance with a technical issue that is
                    currently not covered by the FAQ, you will need to have purchased a Full license of that flavor and
                    contact the respective author for further assistance. The Full version links will be added to the <a
                        href="https://www.gotbootstrap.com/info_app_flavors.html" target="_blank">Flavors</a> page once they
