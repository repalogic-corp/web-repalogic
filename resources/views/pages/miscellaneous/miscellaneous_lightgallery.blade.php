    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_5'])
                ...
                @endslot
                @slot('sh_titile_main')
                    Light Gallery<sup class='badge badge-primary fw-500'>PREMIUM ADDON</sup>
                @endslot
                @slot('sh_descipt')
                    This particular version is catered especially for SmartAdmin, therefore making it unique for your webapp. The
                    plugin is 100% responsive, comes with many extensions, such as autoplay, fullscreen, hash, pager, thumbnail, and
                    zoom. To top it all off, we have integrated jquery.mousehweel and justifiedGallery plugin for justified
                    thumbnails and mousehweel controls.
                @endslot
            @endcomponent
        </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div id="js-lightgallery">
                                <a class="" href="/img/demo/gallery/1.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/2.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/3.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/4.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/5.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/6.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/7.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/8.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/9.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/10.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/11.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/12.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/13.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/14.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/15.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/16.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/17.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/18.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/19.jpg"
                                ...
                                <a class="" href="/img/demo/gallery/20.jpg"
