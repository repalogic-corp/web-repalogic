    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_5'])
                ...
                @endslot
                @slot('sh_titile_main')
                    PaceJS <sup class='badge badge-warning fw-500'>RECOMMENDED</sup>
                @endslot
                @slot('sh_descipt')
                    Include pace.js and a CSS theme of your choice, and you get a beautiful progress indicator for your page load
                    and ajax navigation.
                @endslot
            @endcomponent
        </div>
