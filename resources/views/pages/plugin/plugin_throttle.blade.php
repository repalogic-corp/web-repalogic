    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_5'])
                ...
                @endslot
                @slot('sh_titile_main')
                    Throttle <sup class='badge badge-danger fw-500'>CORE</sup>
                @endslot
                @slot('sh_descipt')
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <figure class="figure my-4">
                                <img src="/img/demo/throttle-no_trailing.png" class="figure-img img-fluid rounded"
                            ...
                            <figure class="figure my-4">
                                <img src="/img/demo/debounce-at_begin.png" class="figure-img img-fluid rounded"
