...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="alert alert-primary alert-dismissible">
            ...
            <br>
            <br>
            Give user access to create panel settings using localstorage. You can change colors, remember collapse state,
            lock location, and add drag functions to panels. Be sure to check out the our exclusive <a
                href="/plugin_smartpanels" target="_blank">SmartPanels</a> plugin.
        </div>
        <div class="row">
            <div class="col-xl-6">
                ...
                <div id="panel-4" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <a href="javascript:void(0);" data-action="panel-collapse" class="text-warning">fullscreen
                                link</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                <code>.panel-hdr</code>. Check out the <a href="/ui_badges" target="_blank">badge page</a>
                                to learn more about badges
                            </div>
                        </div>
