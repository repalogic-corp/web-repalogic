    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_2'])
                ...
                @endslot
                @slot('sh_descipt')
                    Takes the basic nav from above and adds the <code>.nav-tabs</code> class to generate a tabbed interface. Use
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                            ...
                                            <span class="fs-sm d-flex align-items-center mt-3 flex-wrap">
                                                <a href="#" class="mr-1 mt-1" title="Cell A-0012">
                                                    <img src="/img/thumbs/pic-7.png" class="img-share" alt="pic-7"
                                                        style="">
                                                </a>
                                                <a href="#" class="mr-1 mt-1" title="Patient A-473 saliva">
                                                    <img src="/img/thumbs/pic-8.png" class="img-share" alt="pic-8"
                                                        style="">
                                                </a>
                                                <a href="#" class="mr-1 mt-1" title="Patient A-473 blood cells">
                                                    <img src="/img/thumbs/pic-11.png" class="img-share" alt="pic-11"
                                                        style="">
                                                </a>
                                                <a href="#" class="mr-1 mt-1" title="Patient A-473 Membrane O.C">
                                                    <img src="/img/thumbs/pic-12.png" class="img-share" alt="pic-12"
                                                        style="">
                                                </a>
                                            </span>
                                        </div>
