                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                cam be changed using <a href="/utilities_color_pallet" target="_blank"
                                    title="BG Color Utility">color</a> and <a href="/utilities_borders" target="_blank"
                                    title="border utilities">border</a> utilities
                            </div>
                            <!-- demo controls -->
                            <div class="mb-g">
                                <div class="row">
