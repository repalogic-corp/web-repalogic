        ...
        <div class="card mb-g">
            <div class="card-body">
                ...
                <ul class="nav d-block fs-md pl-3">
                    ...
                    <li>
                        <span class="badge bg-fusion-200 fw-n mr-1 width-3">PRJT</span> Added Full project (HTML AJAX Flavor
                        - Alpha release)
                    </li>
                    <li>
                    ...
                    <li>
                        <span class="badge badge-success fw-n mr-1 width-3">*HBS</span> Spell corrections and added links to
                        footer
                    </li>
                    <li>
                ...
                <ul class="nav d-block fs-md pl-3">
                    <li>
                        ...
                        <ul class="nav fs-b ml-3 pl-4 mb-2">
                            <li class="notes">
                                ...
                                base layouts (main.hbs, auth.hbs, and alt.hbs)
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <span class="badge badge-primary fw-n mr-1 width-3">SCRP</span> Added _modules for SmartAdmin WebApp
                        Core
                    </li>
                    <li>
                    ...
                    <li>
                        <span class="badge badge-warning fw-n mr-1 width-3">MISC</span> Added IMG, VIDEO, and MISC directory
                        for all media
                    </li>
                </ul>
            </div>
