    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_5'])
                ...
                @endslot
                @slot('sh_titile_main')
                    C3 Charts<sup class='badge badge-primary fw-500'>ADDON</sup>
                @endslot
                @slot('sh_descipt')
...
@section('plugin')
    ...
    <script>
        ...
        var stepChart = c3.generate({
            ...
            color: {
                pattern: [myapp_get_color.info_500, myapp_get_color.warning_500, myapp_get_color.success_500,
                    myapp_get_color.danger_500, myapp_get_color.fusion_300
                ]
            }
        });
        ...
        var interactiveWheel = c3.generate({
            ...
            color: {
                pattern: [myapp_get_color.primary_500, myapp_get_color.danger_500, myapp_get_color.info_500,
                    myapp_get_color.success_500, myapp_get_color.warning_500
                ]
            },
            grid: {
                x: {
