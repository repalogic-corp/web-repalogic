    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_2'])
                ...
                @endslot
                @slot('sh_descipt')
                    Provide valuable, actionable feedback to your users with HTML5 form validation. Choose from the browser default
                    validation feedback, or implement custom messages with our built-in classes and starter JavaScript.
                @endslot
            @endcomponent
        </div>
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>Validation styles are available for the following form controls and components:
                            ...
                            <code>.custom-checkbox</code> and <code>.custom-radio</code>, <code>.custom-file</code></p>
                        Learn more about forms on bootstrap's <a
                            href="https://getbootstrap.com/docs/4.3/components/forms/#how-it-works" target="_blank">official
                            documentation</a>
                    </div>
                </div>
            </div>
