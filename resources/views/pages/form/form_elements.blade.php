                        ...
                        <form>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input type="text" id="example-gridsize-2" class="form-control"
                                            placeholder=".col">
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group mb-0">
                                            <input class="form-control" id="gridrange" type="range" name="gridrange"
                        ...
                        <form class="form-horizontal">
                            <div class="form-group row">
                                <label for="inputEmail3"
                                    class="col-form-label col-sm-2 text-sm-right form-label">Email</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <label for="inputPassword3"
                                    class="col-form-label col-sm-2 text-sm-right form-label">Password</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <label for="inputPassword5" class="col-form-label col-sm-2 text-sm-right form-label">Re
                                    Password</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row justify-content-end">
                                <div class="col-sm-10">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input text-sm-right"
                                            id="checkmeout">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4 class="card-header">
                    Form row
                    <small>
                        You may also swap <code>.row</code> for <code>.form-row</code>, a variation of our standard grid row
