...
<aside class="page-sidebar">
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            @include('inc.mainmenu.menu_akademik')
            @include('inc.mainmenu.menu_kegiatan_kbm')
            @include('inc.mainmenu.menu_guru')
            @include('inc.mainmenu.menu_wali_kelas')
            @include('inc.mainmenu.menu_bpbk')
            @include('inc.mainmenu.menu_tools_web')
            @include('inc.mainmenu.menu_default')
        </ul>
