<li class="nav-title">Dashboar (Menu Default)</li>
<li class="{{ Request::is('intel*') ? 'active open' : '' }}">
    ...
    <ul>
        ...
        <li class="{{ Request::is('intel_build_notes') ? 'active' : '' }}">
...
<li class="{{ Request::is('info*') ? 'active open' : '' }}">
    ...
    <ul>
        <li class="{{ Request::is('info_app_docs') ? 'active' : '' }}">
            <a href="/info_app_docs" title="Documentation" data-filter-tags="package info documentation">
                <span class="nav-link-text" data-i18n="nav.package_info_documentation">Documentation</span>
            </a>
        </li>
        <li class="{{ Request::is('info_app_licensing') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('info_app_flavors') ? 'active' : '' }}">
...
<li class="{{ Request::is('form*') ? 'active open' : '' }}">
    ...
    <ul>
        ...
        <li class="{{ Request::is('form_checkbox_radio') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('form_input_groups') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('form_validation') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('form_elements') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('form_samples') ? 'active' : '' }}">
...
<li class="{{ Request::is('plugin*') ? 'active open' : '' }}">
    ...
    <ul>
        ...
        <li class="{{ Request::is('plugin_waves') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('plugin_pacejs') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('plugin_smartpanels') ? 'active' : '' }}">
            <a href="/plugin_smartpanels" title="SmartPanels" data-filter-tags="plugins smartpanels">
        ...
        <li class="{{ Request::is('plugin_bootbox') ? 'active' : '' }}">
            <a href="/plugin_bootbox" title="BootBox" data-filter-tags="plugins bootbox alert sound">
        ...
        <li class="{{ Request::is('plugin_slimscroll') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('plugin_throttle') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('plugin_navigation') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('plugin_i18next') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('plugin_appcore') ? 'active' : '' }}">
...
<li class="{{ Request::is('form_plugins*') ? 'active open' : '' }}">
    ...
    <ul>
        ...
        <li class="{{ Request::is('form_plugin_imagecropper') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('form_plugin_select2') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('form_plugin_summernote') ? 'active' : '' }}">
...
<li class="{{ Request::is('page*') ? 'active open' : '' }}">
    ...
    <ul>
        ...
        <li class="{{ Request::is('page_auth*') ? 'active open' : '' }}">
        ...
        <li class="{{ Request::is('page_blank') ? 'active' : '' }}">
            <a href="/page_blank" title="Blank" data-filter-tags="pages blank">
